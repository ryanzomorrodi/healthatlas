...
[![Codecov test coverage](https://codecov.io/gh/ryanzomorrodi/ChicagoHA/branch/main/graph/badge.svg)](https://app.codecov.io/gh/ryanzomorrodi/ChicagoHA?branch=main)
<!-- badges: end -->
...
You can install the development version of healthatlas from [GitHub](https://github.com/ryanzomorrodi/healthatlas) with:
