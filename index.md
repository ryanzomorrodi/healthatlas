...
The most important column here is the `topic_key` which can be used to
identify the topic within subsequent functions.
...
scales that data is available for using
...
Areas geographic layer. We can do that with
